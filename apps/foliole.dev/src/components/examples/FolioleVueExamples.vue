...
<template>
  <div class="w-full">
    <FolioleDrawer @close="handleDrawerClose" :show="showDrawer">
      <div>Example Drawer.</div>
    </FolioleDrawer>
    <button @click="handleDrawerOpen">Open Drawer</button>
    <FolioleAccordion :autocollapse="true">
      <FolioleAccordionItem accordionHeaderClasses="accordion-header" :open="true">
      ...
      <FolioleAccordionItem accordionHeaderClasses="accordion-header">
