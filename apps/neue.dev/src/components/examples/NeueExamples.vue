...
<template>
  <div class="w-full">
    <NeueAccordion :autocollapse="true">
      <NeueAccordionItem accordionHeaderClasses="accordion-header bg-surface-raised" :open="true">
      ...
      <NeueAccordionItem accordionHeaderClasses="accordion-header bg-surface-raised">
