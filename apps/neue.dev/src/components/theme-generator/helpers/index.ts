...
// overload return types of we add more types with different return values, to ensure backwards compatibility
// export function generateRandomColor(): string
// export function generateRandomColor(type: 'hex'): string
